...
exports.compressVideoPost = exports.processVideo = void 0;
...
exports.compressVideoPost = functions
    .runWith({
    timeoutSeconds: 540,
    memory: '2GB',
})
    ...
    if (!filePath || !filePath.startsWith('videos/') || !(contentType === null || contentType === void 0 ? void 0 : contentType.startsWith('video/'))) {
    ...
    try {
        ...
        await new Promise((resolve, reject) => {
            ffmpeg(tempFilePath)
                ...
                .on('progress', (progress) => { var _a; return console.log(`⏳ ${(_a = progress.percent) === null || _a === void 0 ? void 0 : _a.toFixed(1)}%`); })
                .on('end', () => {
        ...
        const token = ((_a = metadata.metadata) === null || _a === void 0 ? void 0 : _a.firebaseStorageDownloadTokens) || Date.now().toString();
