...
// 🔥 KEYBOARD FIX: Uses KeyboardAwareScrollView for reliable keyboard handling
...
const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeToChatMessages(partyId, (chatMessages) => {
      ...
      // Auto-scroll handled by KeyboardAwareScrollView
    });
  ...
  return (
    ...
    >
      <View style={styles.keyboardView} pointerEvents="auto">
        ...
        {/* Messages List with Keyboard Aware Scroll */}
