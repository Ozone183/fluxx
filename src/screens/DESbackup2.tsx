  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderRelease: () => {
        if (currentPoints.length > 1) { // Need at least 2 points
          const newStroke: Stroke = {
            points: [...currentPoints], // Copy the array
          ...
          // Update history
          const newHistory = [...history.slice(0, historyStep + 1), newStrokes];
...
const styles = StyleSheet.create({
  ...
  canvasWrapper: {
    width: CANVAS_SIZE,
    height: SCREEN_HEIGHT - 350, // Full height minus header and toolbar
    borderRadius: 0,
    overflow: 'hidden',
    borderWidth: 0,
  },
