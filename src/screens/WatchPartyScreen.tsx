...
// 🔥 CAMERA FIX + 💬 CHAT INTEGRATION COMPLETE
        ...
        try {
            ...
            daily.on('joined-meeting', async () => {
                ...
                try {
                    ...
                    // Force participant update
                    if (partyId && userId && channelName) {
                        await updateParticipantCount(partyId, userId, channelName, 'join');
                    }
                } catch (error) {
...
>
            ...
            {isInCall && (
                <View style={styles.controls}>
                    ...
                    <TouchableOpacity
                        style={[styles.controlButton, isChatVisible && styles.activeButton]}
